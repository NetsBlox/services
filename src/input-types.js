...
function defineType(info) {
  ...
  else if (typeof (info.hidden) !== "boolean") {
  ...
  else if (typeof (info.displayName) !== "string") {
    throw Error("Display name must be a string");
  } else if (!info.hidden && dispToType[info.displayname]) {
    throw Error(
      `A type (${
  ...
  else if (typeof (info.parser) !== "function") {
