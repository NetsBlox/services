...
TXDNE.getWaifu = function () {
  ...
  return TXDNE._getX(
    this.response,
    `https://www.thiswaifudoesnotexist.net/example-${r}.jpg`,
  );
};
...
TXDNE.getFursona = function () {
  ...
  return TXDNE._getX(
    this.response,
    `https://thisfursonadoesnotexist.com/v2/jpgs/seed${r}.jpg`,
  );
};
...
TXDNE.getPony = function () {
  ...
  return TXDNE._getX(
    this.response,
    `https://thisponydoesnotexist.net/v1/w2x-redo/jpgs/seed${r}.jpg`,
  );
};
...
TXDNE.getHomeInterior = function () {
  ...
  return TXDNE._getX(
    this.response,
    `https://thisrentaldoesnotexist.com/img-new/${options[r]}.jpg`,
  );
};
...
TXDNE.getCongressPerson = function () {
  ...
  return TXDNE._getX(
    this.response,
    `https://vole.wtf/this-mp-does-not-exist/mp/mp${r}.jpg`,
  );
};
