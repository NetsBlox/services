 ...
 */
waterwatch.gageHeight = function (
  minLatitude,
  maxLatitude,
  minLongitude,
  maxLongitude,
  ...
  var options = {
    ...
    "siteType": "GL,ST,GW,GW-MW,SB-CV,LA-SH,FA-CI,FA-OF,FA-TEP,AW",
    "siteStatus": "active",
    "parameterCd": "00065",
  };
 ...
 * @param {Longitude} maxLongitude Maximum longitude of bounding box
 */
waterwatch.streamFlow = function (
  minLatitude,
  maxLatitude,
  minLongitude,
  maxLongitude,
