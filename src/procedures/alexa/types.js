...
function registerTypes() {
  ...
  types.defineType({
    name: "Intent",
    description:
      "An object that holds information about an :doc:`/services/Alexa/index` intent.",
    baseType: "Object",
  ...
  types.defineType({
    name: "SlotType",
    description:
      "The type of slot to use in an :doc:`/services/Alexa/index` skill.",
    baseType: "Enum",
  ...
  types.defineType({
    name: "Slot",
    description:
      "Structured data about a slot in an :doc:`/services/Alexa/index` skill.",
    baseType: "Object",
  ...
  types.defineType({
    name: "SkillCategory",
    description:
      "A category description for an :doc:`/services/Alexa/index` skill.",
    baseType: "Enum",
