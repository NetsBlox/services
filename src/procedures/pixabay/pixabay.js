...
ApiConsumer.trySetGlobalApiKey(pixabay, PixabayKey);
...
pixabay.searchPhoto = function (keywords, maxHeight, minHeight) {
  return this._sendStruct(
    this._encodeQueryOptions(keywords, null, minHeight, "searchPhoto"),
    parserFnGen(maxHeight),
  );
};
...
pixabay.searchIllustration = function (keywords, maxHeight, minHeight) {
  return this._sendStruct(
    this._encodeQueryOptions(keywords, null, minHeight, "searchIllustration"),
    parserFnGen(maxHeight),
  );
};
...
pixabay.searchAll = function (keywords, maxHeight, minHeight) {
  return this._sendStruct(
    this._encodeQueryOptions(keywords, null, minHeight, "searchAll"),
    parserFnGen(maxHeight),
  );
};
