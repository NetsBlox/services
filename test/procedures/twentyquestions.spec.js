...
describe(utils.suiteName(__filename), function () {
  const TwentyQuestions = utils.reqSrc(
    "procedures/twenty-questions/twenty-questions",
  );
    ...
    describe("errors", function () {
      ...
      describe("for answerer", function () {
        ...
        it("should return an error when guessing as an answerer", function () {
          assert.throws(
            () => twentyquestions.guess("books"),
            /You're not the guesser!/,
          );
        });

        it("should return an error when invalid answer", function () {
          assert.throws(
            () => twentyquestions.answer("y"),
            /Answer the guess with yes or no!/,
          );
        });
      });
