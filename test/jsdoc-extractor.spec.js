  ...
  describe("parsing", () => {
    ...
    describe("categories", function () {
      ...
      it("should parse multiple categories", () => {
        ...
        categories.flat().forEach((name, i) =>
          assert.equal(name, `Category${i}`)
        );
      });
    });
  });
  ...
  describe("Docs", () => {
    describe("getDocFor", () => {
      it("should return a copy", () => {
        let Docs = jp.Docs;
        let sampleDocs = {
          rpcs: [{ name: "serviceName", description: "original description" }],
        };
        let targetDoc = Docs.prototype.getDocFor.call(
          sampleDocs,
          "serviceName",
        );
        targetDoc.description = "mutated description";
        let secondGet = Docs.prototype.getDocFor.call(
          sampleDocs,
          "serviceName",
        );
